...
export const extensionsEnUS = {
  ...
  toolbox: {
    ...
    main: {
      ...
      searchPlaceholder: "Search skills, extensions, prompts, and packages",
    ...
    packages: {
      ...
      installChooseLocation: "Hover or click to choose a user or project install.",
    ...
    details: {
      ...
      none: "None",
      skillProtocolLimit:
        "Inputs, outputs, dependencies, source, and scope are not included in the current skill-list response.",
      promptProtocolLimit:
