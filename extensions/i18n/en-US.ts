...
export const extensionsEnUS = {
  ...
  workflows: {
    ...
    create: {
      ...
      description: "Choose an editing experience. All types run on the same flow engine.",
      name: "Name",
      ...
      creating: "Creating…",
      workflowDescription: "Build a DAG visually with conditions and parallel branches.",
      sopDescription: "Create an executable linear checklist with approvals.",
      automationDescription: "Build a flow and attach schedules or internal events.",
    },
    actions: {
      publish: "Publish",
