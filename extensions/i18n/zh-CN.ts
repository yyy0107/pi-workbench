...
export const extensionsZhCN = {
  ...
  modelConfig: {
    ...
    imageInput: "图片输入",
    imageInputDescription: "仅当模型原生接受图片消息时启用；纯文本模型可改用 Workbench 附件理解。",
  ...
  imageUnderstanding: {
    ...
    settings: {
      ...
      routing: {
        label: "附件路由",
        description: "选择 Workbench 应在何时预处理附件；PDF 文档始终需要兼容的 OCR Provider。",
        options: {
      ...
      multimodal: {
        ...
        noConfiguredProviders: "没有已配置且包含图片输入模型的 Provider。",
