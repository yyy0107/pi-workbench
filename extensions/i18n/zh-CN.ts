...
export const extensionsZhCN = {
  ...
  toolbox: {
    ...
    main: {
      search: "搜索能力",
      searchPlaceholder: "搜索 Skills、Extensions、Prompts 和 Packages",
    ...
    packages: {
      ...
      installChooseLocation: "悬浮或点击以选择安装到用户或某个项目。",
    ...
    details: {
      ...
      commands: "注册的命令",
      none: "无",
      skillProtocolLimit: "当前技能列表响应不包含输入、输出、依赖、来源和作用域。",
