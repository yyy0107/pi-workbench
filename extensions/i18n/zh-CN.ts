...
export const extensionsZhCN = {
  ...
  workflows: {
    ...
    inspector: {
      ...
      prompt: "提示词",
      agent: "Agent 工作区",
      agentWorkspaceDescription: "此 Agent 节点使用的工作目录。",
      promptTemplate: "提示词模板",
      promptTemplateRequired: "请输入提示词模板名称。",
      promptDescription: "保存在所选 Pi 提示词模板中的 Agent 指令。",
      promptLoading: "正在加载提示词和 Agent 资源…",
      promptLoadError: "无法加载提示词和 Agent 资源。",
      promptSaving: "正在保存提示词…",
      promptSaved: "提示词已保存。",
      promptSaveError: "无法保存提示词，请重试。",
      promptUnsaved: "离开此输入框时将保存提示词更改。",
      skills: "可用 Skills",
      extensions: "可用扩展",
      noSkills: "当前没有此 Agent 可用的已启用 Skill。",
      noExtensions: "当前没有此 Agent 可用的已启用扩展。",
      resourcesLoading: "正在加载 Agent 资源…",
      resourcesUnavailable: "Agent 资源当前不可用。",
      resourcesRequireTrust:
        "信任此工作流目录后，才会显示 Agent 本地的 Skills 和扩展；已启用的用户级资源仍会显示。",
      skillManualOnly: "仅支持显式调用",
      resourceScope: {
        user: "用户",
        agent: "Agent",
        temporary: "临时",
      ...
      outputSchemaDescription: "Agent 必须提交符合此 Schema 的 JSON 对象。",
      outputSchemaInvalid: "请输入有效的 JSON。",
      outputSchemaObjectRequired: "输出 Schema 必须是 JSON 对象。",
      command: "命令",
      relativeCwd: "相对工作目录",
      timeout: "超时（秒）",
