...
export const extensionsZhCN = {
  ...
  modelConfig: {
    ...
    imageInput: "图片输入",
    imageInputDescription: "仅当模型原生接受图片消息时启用；纯文本模型可改用 Workbench 图片理解。",
  ...
  imageUnderstanding: {
    title: "图片理解",
    description: "在纯文本模型运行前，通过 OCR API 或多模态模型识别图片内容。",
    settings: {
      loading: "正在加载图片理解设置…",
      retry: "重试",
      save: "保存",
      ...
      routing: {
        label: "图片路由",
        description: "选择 Workbench 应在何时预处理图片附件。",
        options: {
          auto: "自动",
          alwaysPreprocess: "始终预处理",
          nativeOnly: "仅使用模型原生视觉",
          disabled: "已禁用",
        },
      },
      engine: {
      ...
      errors: {
        loadFailed: "无法加载图片理解设置。",
        saveFailed: "无法保存图片理解设置，请重试。",
        conflict: "这些设置已在其他位置更改，请重新加载后再试。",
        requiredFields: "请先填写完整的必填端点、Provider 和模型字段。",
    ...
    recognition: {
      ...
      ) => `已完成 ${number(completed)} / ${number(total)} 张图片`,
      progressLabel: "图片识别进度",
