    ...
    <>
      <div className={fieldClass}>
        ...
        <Input
          ...
          aria-describedby={!promptTemplate ? "workflow-node-prompt-template-error" : undefined}
          onChange={(event) => update("promptTemplate", event.currentTarget.value)}
        />
        {!promptTemplate ? (
          <p id="workflow-node-prompt-template-error" className="text-xs text-destructive">
      ...
      <div className={fieldClass}>
        ...
        <Textarea
          ...
          aria-describedby="workflow-node-prompt-status"
          onChange={(event) => {
        ...
        />
        <p
          id="workflow-node-prompt-status"
  ...
  return (
    <div className={fieldClass}>
      ...
      <Textarea
        ...
        aria-describedby="workflow-node-output-schema-help"
        onChange={(event) => {
      ...
      />
      <p
        id="workflow-node-output-schema-help"
          ...
          <div className={fieldClass}>
            ...
            <InputGroup className="[background:var(--input-control-background-disabled)]">
              ...
              <InputGroupInput
                ...
                aria-describedby="workflow-node-agent-description"
                readOnly
              />
            </InputGroup>
            <p
              id="workflow-node-agent-description"
