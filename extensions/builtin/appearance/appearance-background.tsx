...
export function AppearanceBackground() {
  ...
  useEffect(() => {
    ...
    const themeProperties = {
      ...
      "--workbench-light-ui-font": UI_FONT_STACKS[preferences.lightUiFont],
      "--workbench-light-code-font": CODE_FONT_STACKS[preferences.lightCodeFont],
      ...
      "--workbench-dark-ui-font": UI_FONT_STACKS[preferences.darkUiFont],
      "--workbench-dark-code-font": CODE_FONT_STACKS[preferences.darkCodeFont],
