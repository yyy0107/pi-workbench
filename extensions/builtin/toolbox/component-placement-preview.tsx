...
import type { WorkbenchSlot } from "@/platform/extensions";
  ...
  return (
    <aside className="bg-sidebar text-sidebar-foreground relative flex min-h-0 flex-col border-r">
      ...
      {activeRegion === "sidebar.header"
        ? target(
            "sidebar.header",
            t("extensions.toolbox.details.projectRegions.sidebarHeader"),
            ...
            <>
              ...
              <span className="text-muted-foreground text-[6px]">
                {t("extensions.toolbox.details.projectPanorama.connected")}
              </span>
            </>,
          )
        : null}
      ...
      <div className="flex h-5 shrink-0 items-center gap-0.5 ps-[21px] pe-0.5">
        ...
        >
          ...
          {!toolboxMode ? (
            <span className="ms-1 truncate">
              {t("extensions.toolbox.details.projectPanorama.workspace")}
            </span>
          ) : null}
        </span>
        <span
        ...
        >
          ...
          {toolboxMode ? (
            <span className="ms-1 truncate">
              {t("extensions.toolbox.details.projectPanorama.toolbox")}
            </span>
          ) : null}
        </span>
      ...
      {activeRegion === "sidebar.navigation"
        ? target(
            "sidebar.navigation",
            t("extensions.toolbox.details.projectRegions.navigation"),
      ...
      {toolboxMode ? (
        <div className="flex min-h-0 flex-1 flex-col px-2 pt-2">
          <div className="px-1 text-[6px] font-semibold tracking-wide text-muted-foreground uppercase">
            {t("extensions.toolbox.details.projectPanorama.capabilities")}
          </div>
          {target(
            "sidebar.toolbox",
            t("extensions.toolbox.details.projectRegions.toolbox"),
            "mt-1 grid gap-1",
            <>
              <div className="flex items-center gap-1 rounded-md px-1.5 py-1 text-[7px]">
                <WrenchIcon className="size-2.5" />
                <span className="flex-1">
                  {t("extensions.toolbox.details.projectPanorama.skills")}
                </span>
              ...
              <div className="bg-sidebar-accent flex items-center gap-1.5 rounded-md px-1.5 py-1.5 text-[7px] font-medium">
                ...
                <span className="min-w-0 flex-1 truncate">{t("extensions.generativeUi.name")}</span>
        ...
        <div className="flex min-h-0 flex-1 flex-col px-2 pt-2">
          <div className="order-2 flex h-5 items-center gap-1 rounded-md px-1 text-[6.5px] font-medium text-muted-foreground">
            <span className="flex-1">
              {t("extensions.toolbox.details.projectPanorama.projects")}
            </span>
            <ChevronDownIcon className="size-2.5" />
            {target(
              "sidebar.workspace.actions",
              t("extensions.toolbox.details.projectRegions.workspace"),
              "flex items-center",
          ...
          <div className="order-3 mt-1 grid gap-0.5">
            ...
            <div className="bg-sidebar-accent flex h-8 items-center gap-1.5 rounded-md px-1.5">
              ...
              <span className="min-w-0 flex-1">
                <span className="block truncate text-[7px] font-medium">
                  {t("extensions.toolbox.details.projectPanorama.activeThread")}
                </span>
            ...
            <div className="flex h-7 items-center gap-1.5 rounded-md px-1.5 text-[6.5px] text-muted-foreground">
              ...
              <span className="truncate">
                {t("extensions.toolbox.details.projectPanorama.previousThread")}
              </span>
            </div>
          </div>
          {target(
            "sidebar.bottom",
            t("extensions.toolbox.details.projectRegions.sidebarBottom"),
            ...
            <>
              ...
              <span>{t("extensions.toolbox.details.projectPanorama.backgroundTask")}</span>
            </>,
          )}
        </div>
      )}
      ...
      {target(
        "sidebar.footer",
        t("extensions.toolbox.details.projectRegions.footer"),
        ...
        <>
          ...
          <span className="flex-1 text-[6.5px]">
            {t("extensions.toolbox.details.projectPanorama.settings")}
          </span>
          <span className="text-muted-foreground flex items-center gap-1 text-[5.5px]">
            <LanguagesIcon className="size-2.5" />
            {t("extensions.toolbox.details.projectPanorama.localeName")}
          </span>
        </>,
      )}
    </aside>
    ...
    <header className="bg-background grid h-5 shrink-0 grid-cols-[1fr_auto_1fr] items-center border-b ps-1.5 pe-1.5">
      <div className="flex min-w-0 items-center gap-1">
        <span className="truncate text-[7px] font-semibold">
          {toolboxMode
            ? t("extensions.toolbox.componentExtensions.title")
            : t("extensions.toolbox.details.projectPanorama.activeThread")}
        </span>
      ...
      {activeRegion === "header.center"
        ? target(
            "header.center",
            t("extensions.toolbox.details.projectRegions.header"),
...
function MiniConversation({ activeRegion }: { activeRegion: ProjectPreviewRegion }) {
  ...
  const messageRoleLabels = {
    assistant: t("extensions.toolbox.details.projectPanorama.messageRoles.assistant"),
    system: t("extensions.toolbox.details.projectPanorama.messageRoles.system"),
    user: t("extensions.toolbox.details.projectPanorama.messageRoles.user"),
  } as const;
  const messageSlotExample = (
    ...
    activeRegion === region
      ? target(
          ...
          t("extensions.toolbox.details.projectPanorama.messageSlotExample", {
      ...
      <>
        {activeRegion === "message.actions" ? (
          <span className="me-1 text-[5px] font-medium text-sky-700 dark:text-sky-200">
            {t("extensions.toolbox.details.projectPanorama.messageActionsExample", {
              role: messageRoleLabels[role],
            })}
          </span>
        ) : null}
    ...
    <div className="relative flex size-full min-h-0 flex-col overflow-hidden bg-background">
      {activeRegion === "thread.header"
        ? target(
            ...
            <span>{t("extensions.toolbox.details.projectPanorama.today")}</span>,
          )
        : null}
      ...
      <div className="relative mx-auto min-h-0 w-full max-w-[24rem] flex-1 px-4 pt-2">
        ...
        <div className="mb-1">
          ...
          <div className="text-muted-foreground flex items-center gap-1.5 text-[5.5px]">
            ...
            <span className="rounded-full border bg-background px-1.5 py-0.5">
              {t("extensions.toolbox.details.projectPanorama.systemMessage")}
            </span>
            <span className="h-px flex-1 bg-border" />
          </div>
        ...
        <div className="mb-1.5 flex flex-col items-end">
          ...
          <div className="max-w-[74%] rounded-xl rounded-br-sm bg-muted px-2.5 py-1.5 text-[6.5px] leading-[1.35]">
            <div>{t("extensions.toolbox.details.projectPanorama.userMessage")}</div>
            <div className="mt-1 flex flex-wrap justify-end gap-1 text-[5px] text-muted-foreground">
              <span className="rounded border bg-background/70 px-1 py-0.5">
                {t("extensions.toolbox.details.projectPanorama.imageMessage")}
              </span>
              <span className="rounded border bg-background/70 px-1 py-0.5">
                {t("extensions.toolbox.details.projectPanorama.fileMessage")}
              </span>
            </div>
          </div>
        ...
        {target(
          "message.root",
          t("extensions.toolbox.details.projectRegions.message"),
          "p-1",
          <div className="w-full min-w-0">
            {messageSlotExample("message.before", "assistant")}
            <p className="text-[6px] leading-[1.4]">
              {t("extensions.toolbox.details.projectPanorama.assistantTextMessage")}
            </p>
            <div className="mt-1 grid grid-cols-2 gap-1 text-[5px] text-muted-foreground">
              <span className="rounded-md border bg-muted/30 px-1.5 py-1">
                {t("extensions.toolbox.details.projectPanorama.reasoningMessage")}
              </span>
              <span className="rounded-md border bg-muted/30 px-1.5 py-1">
                {t("extensions.toolbox.details.projectPanorama.toolMessage")}
              </span>
            </div>
            {target(
              "message.content",
              t("extensions.toolbox.details.projectRegions.part"),
              "mt-1 rounded-lg border bg-card p-2 shadow-sm",
              <>
                <div className="flex items-start gap-2">
                  <div className="min-w-0 flex-1">
                    <div className="truncate text-[8px] font-semibold">
                      {t("extensions.generativeUi.preview.title")}
                    </div>
                    <div className="mt-0.5 truncate text-[6px] text-muted-foreground">
                      {t("extensions.generativeUi.preview.caption")}
                    </div>
                  </div>
                  <span className="rounded-md border px-2 py-1 text-[6px] font-medium">
                    {t("extensions.generativeUi.preview.action")}
                  </span>
                </div>
                <div className="my-2 border-t" />
                <p className="line-clamp-2 text-[6.5px] leading-[1.45] text-muted-foreground">
                  {t("extensions.generativeUi.preview.body")}
                </p>
              </>,
            )}
            <div className="mt-1 flex flex-wrap gap-1 text-[5px] text-muted-foreground">
              <span className="rounded-full bg-muted px-1.5 py-0.5">
                {t("extensions.toolbox.details.projectPanorama.dataMessage")}
              </span>
              <span className="rounded-full bg-muted px-1.5 py-0.5">
                {t("extensions.toolbox.details.projectPanorama.sourceMessage")}
              </span>
              <span className="rounded-full bg-muted px-1.5 py-0.5">
                {t("extensions.toolbox.details.projectPanorama.audioMessage")}
              </span>
              <span className="rounded-full bg-destructive/10 px-1.5 py-0.5 text-destructive">
                {t("extensions.toolbox.details.projectPanorama.errorMessage")}
              </span>
            </div>
      ...
      <div className="mx-auto grid h-full max-w-[28rem] grid-rows-[auto_auto_1fr] gap-2">
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0">
            <div className="text-[9px] font-semibold">{t("extensions.generativeUi.name")}</div>
            <div className="text-[6px] text-muted-foreground">
              {t("extensions.toolbox.origins.installedComponent")}
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-2 rounded-lg border p-2 text-[6px]">
          <div>
            <div className="text-muted-foreground">
              {t("extensions.toolbox.details.insertionPosition")}
            </div>
            <div className="mt-0.5 font-medium">
              {t("extensions.generativeUi.placement.surface")}
            </div>
          </div>
          <div>
            <div className="text-muted-foreground">
              {t("extensions.toolbox.details.extensionPoint")}
            </div>
        ...
        <div className="grid min-h-0 grid-cols-[1.15fr_0.85fr] gap-2">
            ...
            <div className="mt-2 rounded-md border bg-background p-2">
              <div className="flex items-center gap-1">
                <span className="rounded bg-muted px-1 py-0.5 text-[5.5px]">
                  {t("extensions.toolbox.componentContributionKinds.messagePartRenderer")}
                </span>
              ...
              <div className="mt-2 grid grid-cols-2 gap-2 text-[5.5px]">
                ...
                <div>
                  <div className="text-muted-foreground">
                    {t("extensions.toolbox.details.renderMountPoint")}
                  </div>
          ...
          <div className="rounded-lg border p-2">
            <div className="text-[6px] font-semibold">
              {t("extensions.toolbox.details.stylePreview")}
            </div>
...
function MiniWorkspace({ activeRegion }: { activeRegion: ProjectPreviewRegion }) {
  ...
  return (
    <aside className="bg-background flex min-h-0 flex-col border-l">
      ...
      {target(
        "workspace.surface",
        t("extensions.toolbox.details.projectRegions.surface"),
...
function MiniStatusbar({ activeRegion }: { activeRegion: ProjectPreviewRegion }) {
  ...
  return (
    <footer className="bg-background text-muted-foreground flex h-3.5 shrink-0 items-center justify-between gap-2 border-t px-1.5 text-[5.5px]">
      ...
      >
        <span>{t("extensions.toolbox.details.projectPanorama.runtimeReady")}</span>
        <span>{t("extensions.toolbox.details.projectPanorama.turns")}</span>
        <span>·</span>
        <span>{t("extensions.toolbox.details.projectPanorama.steps")}</span>
        <span>|</span>
        <span>{t("extensions.toolbox.details.projectPanorama.llmTime")}</span>
        <span>|</span>
        <span>{t("extensions.toolbox.details.projectPanorama.inputTokens")}</span>
        <span>·</span>
        <span>{t("extensions.toolbox.details.projectPanorama.outputTokens")}</span>
      </PanoramaTarget>
    </footer>
  );
}
...
function MiniPanel({
  ...
  return (
    <PanoramaTarget
      activeRegion={activeRegion}
      region={region}
      label={t("extensions.toolbox.details.projectRegions.panel")}
      className={cn(
    ...
    >
      <div className="flex h-7 items-center gap-1 border-b px-2 text-[6.5px] font-semibold">
        ...
        {t("extensions.toolbox.details.projectPanorama.panelTitle")}
    ...
    <div className="absolute inset-0 z-40 flex items-center justify-center bg-background/55 p-6 backdrop-blur-[1px]">
      {settingsActive ? (
        <PanoramaTarget
          activeRegion={activeRegion}
          region="settings"
          label={t("extensions.toolbox.details.projectRegions.settings")}
        ...
        >
          <div className="bg-muted/40 border-r p-2">
            ...
            {[
              t("extensions.toolbox.details.projectPanorama.general"),
              t("extensions.toolbox.details.projectPanorama.appearance"),
              t("extensions.toolbox.details.projectPanorama.language"),
            ].map((item, index) => (
              <div
                key={item}
                className={cn(
          ...
          <div className="p-3">
            ...
            <div className="mt-3 grid gap-2">
              ...
              <div className="flex items-center justify-between rounded-lg border p-2 text-[6px]">
                <span>{t("extensions.toolbox.details.projectPanorama.language")}</span>
        ...
        <PanoramaTarget
          ...
          label={t("extensions.toolbox.details.projectRegions.overlay")}
        ...
        >
          <div className="flex h-8 items-center gap-2 rounded-lg border px-2 text-[7px] text-muted-foreground">
            ...
            {t("extensions.toolbox.details.projectPanorama.commandSearch")}
          </div>
          <div className="mt-1 rounded-lg bg-muted/45 px-2 py-2 text-[7px] font-medium">
            {t("extensions.toolbox.details.projectPanorama.openComponentExtension")}
          </div>
        </PanoramaTarget>
      )}
    </div>
...
export function ComponentPlacementPreview({
  ...
  return (
    <figure
      ...
      aria-label={t("extensions.toolbox.details.projectPreviewAria", {
    ...
    >
      <div className="overflow-x-auto pb-1">
        <PanoramaTarget
          ...
          label={t("extensions.toolbox.details.projectRegions.background")}
          className={cn(
      ...
      <figcaption className="text-muted-foreground flex items-start gap-2 text-xs leading-5">
        ...
        <span>
          {t("extensions.toolbox.details.projectPreviewLegend", {
            surface: contribution.surface,
          })}
        </span>
      </figcaption>
