...
import { detectLinuxApps } from "../../src/local-apps/detector-linux";
import { detectMacOSApps } from "../../src/local-apps/detector-macos";
import { detectWindowsApps } from "../../src/local-apps/detector-windows";
