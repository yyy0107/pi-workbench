...
import type { ExecutionNodeExecutorRegistry } from "./node-executor";
...
export class ExecutionService implements ExecutionProtocol {
  ...
  async initialize(): Promise<void> {
    ...
    const initializing = this.engine.initialize().then(() => {
  ...
  /** Stops new run admission and waits for active/queued execution state to settle. */
