...
const workbenchSettingsUpdatePayload = rpcObject({
  patch: rpcObject({
    ...
    piExtensionPromptEnabled: rpcOptional(rpcNullable(rpcBoolean)),
    piHookPromptEnabled: rpcOptional(rpcNullable(rpcBoolean)),
    piToolPromptEnabled: rpcOptional(rpcNullable(rpcBoolean)),
    piSkillPromptEnabled: rpcOptional(rpcNullable(rpcBoolean)),
