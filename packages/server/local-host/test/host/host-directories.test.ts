...
const {
  ...
  new URL("../../src/host-directories.ts", import.meta.url).href
)) as typeof import("@workbench/local-host-server/directories");

type HostDirectoryErrorCode =
  import("@workbench/local-host-server/directories").HostDirectoryErrorCode;
type HostPathRunner = import("@workbench/local-host-server/directories").HostPathRunner;
