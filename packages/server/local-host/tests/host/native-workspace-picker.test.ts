...
const { NativeWorkspacePickerUnavailableError, pickNativeWorkspaceDirectory } = (await import(
  new URL("../../src/native-workspace-picker.ts", import.meta.url).href
)) as typeof import("@workbench/local-host-server/picker");

type NativeWorkspacePickerRunner =
  import("@workbench/local-host-server/picker").NativeWorkspacePickerRunner;
