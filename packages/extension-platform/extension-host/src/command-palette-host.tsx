...
import { useCommandService, useExtensionErrorReporter } from "./extension-context";
import { platformExtensionsTranslationBundle } from "./i18n";
...
export function CommandPaletteHost({
  ...
  const paletteShortcut = useMemo(() => normalizeCommandPaletteShortcut(shortcut), [shortcut]);
