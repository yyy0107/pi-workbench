...
import { ExtensionManager, OpenerRegistryImpl } from "@workbench/extension-sdk/internal";
import type { OpenResourceRequest, WorkspaceSurfaceOpenOperations } from "@workbench/extension-sdk";

import { DefaultOpenerService } from "../src/services/opener-service";
