...
import type {
  PiConnectionTimers,
  PiWebSocket,
  PiWebSocketMessageEvent,
} from "../../src/transport/connections";

const { PiConnectionController } = (await import(
  new URL("../../src/transport/connections.ts", import.meta.url).href
)) as typeof import("../../src/transport/connections");
