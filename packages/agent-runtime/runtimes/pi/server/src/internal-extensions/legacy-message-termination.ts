...
import { LEGACY_WORKBENCH_MESSAGE_TERMINATION_EXTENSION_SOURCE } from "./legacy-message-termination-extension-source";
...
export function legacyWorkbenchMessageTerminationExtensionSource(): string {
  return LEGACY_WORKBENCH_MESSAGE_TERMINATION_EXTENSION_SOURCE;
}
