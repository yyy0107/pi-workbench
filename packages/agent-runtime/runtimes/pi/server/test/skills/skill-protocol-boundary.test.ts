...
const SKILL_SERVICE = new URL("../../src/skills/skill-service.ts", import.meta.url);
const SKILL_RPC_ROUTES = new URL("../../src/transport/routes/skill-rpc-routes.ts", import.meta.url);
