...
const { NativeWorkspacePickerUnavailableError, pickNativeWorkspaceDirectory } = (await import(
  new URL("../../src/host/native-workspace-picker.ts", import.meta.url).href
)) as typeof import("../../src/host/native-workspace-picker");

type NativeWorkspacePickerRunner =
  import("../../src/host/native-workspace-picker").NativeWorkspacePickerRunner;
