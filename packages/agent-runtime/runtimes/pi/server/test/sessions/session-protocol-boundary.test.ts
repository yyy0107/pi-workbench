...
const SESSION_RPC_SERVICE = new URL("../../src/sessions/session-rpc-service.ts", import.meta.url);
const SESSION_PROTOCOL_FACADE = new URL(
  "../../src/sessions/pi-session-protocol-facade.ts",
  import.meta.url,
);
const SESSION_CONTEXT_TRACE_SERVICE = new URL(
  "../../src/sessions/pi-session-context-trace-service.ts",
  import.meta.url,
);
const EXTERNAL_SESSION_IMPORT_SERVICE = new URL(
  "../../src/imports/external-session-import-service.ts",
  import.meta.url,
);
const EXTERNAL_SESSION_TYPES = new URL(
  "../../src/imports/external-session-types.ts",
  import.meta.url,
);
...
const SESSION_CONTEXT_TRACE_RPC_ROUTES = new URL(
  "../../src/transport/routes/session-context-trace-rpc-routes.ts",
  import.meta.url,
);
const EXTERNAL_SESSION_IMPORT_RPC_ROUTES = new URL(
  "../../src/transport/routes/external-session-import-rpc-routes.ts",
  import.meta.url,
);
