...
const AUTOMATION_MAIN_VIEW_TITLE = definePiMessage("extensions.automations.automationHome.title");
const NEW_AUTOMATION_TASK_TITLE = definePiMessage("extensions.automations.breadcrumb.newTask");
const EDIT_AUTOMATION_TASK_TITLE = definePiMessage("extensions.automations.breadcrumb.editor");
