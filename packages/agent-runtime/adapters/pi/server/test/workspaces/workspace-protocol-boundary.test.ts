...
const WORKSPACE_PROTOCOL_SERVICE = new URL(
  "../../src/workspaces/workspace-protocol-service.ts",
  import.meta.url,
);
const WORKSPACE_STORE = new URL("../../src/workspaces/workspace-store.ts", import.meta.url);
const WORKSPACE_RPC_ROUTES = new URL(
  "../../src/transport/routes/workspace-rpc-routes.ts",
  import.meta.url,
);
const WORKSPACE_FILE_RPC_ROUTES = new URL(
  "../../src/transport/routes/workspace-file-rpc-routes.ts",
  import.meta.url,
);
const WORKSPACE_FILES = new URL("../../src/workspaces/workspace-files.ts", import.meta.url);
const WORKSPACE_FILE_CONTENT = new URL(
  "../../src/workspaces/workspace-file-content.ts",
  import.meta.url,
);
