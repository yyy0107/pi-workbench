...
const COMMAND_SERVICE = new URL("../../src/commands/command-service.ts", import.meta.url);
const PROMPT_SERVICE = new URL("../../src/prompts/prompt-service.ts", import.meta.url);
const HOST_ROUTES = new URL("../../src/transport/routes/host-rpc-routes.ts", import.meta.url);
const LOCAL_APP_ROUTES = new URL(
  "../../src/transport/routes/local-app-rpc-routes.ts",
  import.meta.url,
);
const PROJECT_TRUST_ROUTES = new URL(
  "../../src/transport/routes/project-trust-rpc-routes.ts",
  import.meta.url,
);
const RESOURCE_CATALOG_ROUTES = new URL(
  "../../src/transport/routes/resource-catalog-rpc-routes.ts",
  import.meta.url,
);
