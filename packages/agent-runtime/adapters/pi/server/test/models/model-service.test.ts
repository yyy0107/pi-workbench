...
type ModelRuntimeProvider = import("../../src/models/model-service").ModelRuntimeProvider;
type ModelConfigStorage = import("../../src/models/model-config-store").ModelConfigStorage;
type StoredModelProviderConfiguration =
  import("../../src/models/model-config-store").StoredModelProviderConfiguration;
