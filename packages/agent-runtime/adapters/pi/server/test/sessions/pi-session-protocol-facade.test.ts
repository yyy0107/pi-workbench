...
import type { WorkspaceView } from "@workbench/agent-runtime-pi-protocol/rpc";
...
import { createPiSessionProtocolFacade } from "../../src/sessions/pi-session-protocol-facade";
import type { SessionRpcWorkspaceStore } from "../../src/sessions/session-rpc-service";
...
const execution: AgentExecutionPort = {
  ...
  cancel: async () => {},
  regeneration: { regenerate: async () => {} },
  resume: { resume: async () => {} },
  branches: { select: async () => {} },
  queue: { update: async () => {} },
};
