...
import { MAX_ATTACHMENT_RECOGNITION_RESULT_CHARACTERS } from "@workbench/attachment-understanding-contracts/state-machine";

import { projectAttachmentRecognitionResults } from "../../src/attachment-understanding/display-results";
