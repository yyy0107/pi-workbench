...
const EXPOSED_DOMAIN_ERRORS = [
  ...
  [
    "packages/agent-runtime/adapters/pi/server/src/commands/command-service.ts",
    "CommandServiceError",
  ],
  [
    "packages/agent-runtime/adapters/pi/server/src/extensions/extension-service.ts",
    "ExtensionServiceError",
  ],
  ["packages/agent-runtime/adapters/pi/server/src/host/host-directories.ts", "HostDirectoryError"],
  ["packages/agent-runtime/adapters/pi/server/src/local-apps/service.ts", "LocalAppServiceError"],
  ["packages/agent-runtime/adapters/pi/server/src/models/model-service.ts", "ModelServiceError"],
  [
    "packages/agent-runtime/adapters/pi/server/src/packages/installed-package-service.ts",
    "InstalledPackageServiceError",
  ],
  [
    "packages/agent-runtime/adapters/pi/server/src/packages/package-catalog-service.ts",
    "PiPackageCatalogServiceError",
  ],
  [
    "packages/agent-runtime/adapters/pi/server/src/resources/scoped-resource-context.ts",
    "ScopedResourceContextError",
  ],
  [
    "packages/agent-runtime/adapters/pi/server/src/sessions/pi-session-context-trace-service.ts",
    "PiSessionContextTraceServiceError",
  ],
  [
    "packages/agent-runtime/adapters/pi/server/src/sessions/session-rpc-service.ts",
  ...
  [
    "packages/agent-runtime/adapters/pi/server/src/workspaces/workspace-files.ts",
    "WorkspaceFileError",
  ],
  [
    "packages/agent-runtime/adapters/pi/server/src/workspaces/workspace-protocol-service.ts",
