  ...
  extensions: {
    ...
    workflows: {
      ...
      trust: {
        ...
        selectError: "Unable to select this workflow folder.",
      },
      workflowHome: {
        title: "Workflows",
        description:
          "Build repeatable processes from agents, commands, conditions, and human approvals.",
        runHistory: "Run history",
        newWorkflow: "New workflow",
        ...
        workflowCount: ({ count }: { count: number }, { number }: MessageFormatters) =>
          `${number(count)} ${count === 1 ? "workflow" : "workflows"}`,
        loading: "Loading workflows…",
        loadFailed: "Workflows could not be loaded.",
        empty: "No workflows yet",
        emptyDescription:
          "Connect agents, commands, conditions, and approvals into a process you can run again whenever you need it.",
        createBlank: "Create blank workflow",
        browseTemplates: "Browse templates",
        startFromTemplate: "Start from a template",
        templateDescription: "Use a proven structure, then adjust its steps for your project.",
        draft: "Draft",
        published: "Published",
        personal: "Personal",
        project: "Project",
        ...
        deleteDescription:
          "This workflow will be removed from My workflows and cannot be restored from this page.",
        cancelDelete: "Cancel",
        confirmDelete: "Delete",
        deleting: "Deleting…",
        deletedFeedback: ({ name }: { name: string }) => `${name} was deleted.`,
        deleteFailed: ({ name }: { name: string }) => `${name} could not be deleted. Try again.`,
        viewRunsFor: ({ name }: { name: string }) => `View runs for ${name}`,
        openWorkflow: ({ name }: { name: string }) => `Open ${name}`,
        runStatus: {
          queued: "Queued",
          running: "Running",
          waitingForApproval: "Waiting for approval",
      ...
      create: {
        ...
        description: "Set the workflow name and scope, then continue in the editor.",
        details: "Workflow information",
        name: "Name",
        namePlaceholder: "Untitled workflow",
        scope: "Scope",
        personal: "Personal",
        personalDescription: "Stored locally and available across projects.",
        project: "Project",
        projectDescription: "Published to the selected project's .pi/workflows folder.",
        workspace: "Project workspace",
        noWorkspace: "No project workspace is available.",
        personalSummary: "A draft will be created in your personal space.",
        projectSummary: ({ project }: { project: string }) =>
          `A draft will be created in ${project}.`,
        cancel: "Cancel",
        submit: "Create and open editor",
        creating: "Creating…",
        createFailed: "The workflow could not be created. Check the settings and try again.",
      },
      actions: {
        publish: "Publish",
      ...
      editor: {
        ...
        loadFailed: "This workflow could not be loaded.",
        empty: "Select a workflow from the sidebar.",
        canvasLabel: "Workflow canvas",
        nodePalette: "Node palette",
        validationFailed: "Resolve validation issues before publishing.",
        publishSucceeded: "Published",
        runStarted: "Run started",
        copyName: ({ name }: { name: string }) => `${name} copy`,
        connectHint: "Connect nodes to define execution order.",
      },
      node: {
        start: "Start",
        end: "End",
      ...
      inspector: {
        ...
        agentWorkspaceDescription: "Working directory used by this Agent node.",
        promptTemplate: "Prompt template",
        promptTemplateRequired: "Enter a prompt template name.",
        promptDescription: "Instructions saved in the selected Pi prompt template.",
        promptLoading: "Loading the prompt and Agent resources…",
        promptLoadError: "The prompt and Agent resources could not be loaded.",
        promptSaving: "Saving prompt…",
        promptSaved: "Prompt saved.",
        promptSaveError: "The prompt could not be saved. Try again.",
        promptUnsaved: "Prompt changes will be saved when you leave this field.",
        skills: "Available Skills",
        extensions: "Available extensions",
        noSkills: "No enabled Skills are available to this Agent.",
        noExtensions: "No enabled extensions are available to this Agent.",
        resourcesLoading: "Loading Agent resources…",
        resourcesUnavailable: "Agent resources are currently unavailable.",
        resourcesRequireTrust:
          "Trust this workflow folder to include Agent-local Skills and extensions. Enabled user resources are still shown.",
        skillManualOnly: "Explicit invocation only",
        resourceScope: {
          user: "User",
          agent: "Agent",
          temporary: "Temporary",
        ...
        outputSchemaDescription: "The Agent must submit a JSON object matching this schema.",
        outputSchemaInvalid: "Enter valid JSON.",
        outputSchemaObjectRequired: "The output schema must be a JSON object.",
        command: "Command",
        relativeCwd: "Relative working directory",
        timeout: "Timeout (seconds)",
        approvalMessage: "Approval request",
        bindingPath: "Input JSON Pointer",
        operator: "Operator",
        compareValue: "Comparison value (JSON)",
        removeNode: "Remove node",
        startEndLocked: "Start and End are maintained by the system.",
      },
      runs: {
        title: "Run history",
      ...
      templates: {
        ...
        description: "Templates create drafts only. Nothing is enabled automatically.",
        use: "Use template",
        dailySummary: "Daily work summary",
        dailySummaryDescription: "Automation with a weekday schedule and an Agent summary step.",
        prReview: "PR Review",
        prReviewDescription:
          "Workflow for inspecting changes, running checks, and summarizing risk.",
      },
    },
    toolbox: {
      title: "Toolbox",
      ...
      details: {
        ...
        projectPreviewLegend: ({ surface }: { surface: string }) =>
          `Highlighted region: ${surface}`,
        projectRegions: {
        ...
        projectPanorama: {
          ...
          messageActionsExample: ({ role }: { role: string }) =>
            `${role} · message.actions example`,
