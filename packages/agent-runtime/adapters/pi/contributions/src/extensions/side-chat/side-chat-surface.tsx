...
import { PiBoundSessionProvider } from "@workbench/agent-runtime-pi-client/side-chat";
...
function SideChatConversation({ params }: Readonly<{ params: SideChatSurfaceParams }>) {
  ...
  return (
    <PiBoundSessionProvider sessionId={params.scratchSessionId}>
