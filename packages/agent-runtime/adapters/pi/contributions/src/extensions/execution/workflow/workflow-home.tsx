...
export function WorkflowHome() {
  ...
  const titleId = `${domScopeId}-workflow-home-title`;
  const attentionTitleId = `${domScopeId}-workflow-home-attention-title`;
  const listTitleId = `${domScopeId}-workflow-home-list-title`;
  const templateTitleId = `${domScopeId}-workflow-home-template-title`;
  ...
  const deleteWorkflow = async () => {
    ...
    try {
      ...
      catalogStore.getState().applyHostPayload({
  ...
  return (
    <main aria-labelledby={titleId} className="bg-background h-full min-h-0 overflow-y-auto">
      <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-8 sm:py-10 lg:py-12">
        ...
        {needsAttention ? (
          ...
          >
            <div className="border-border flex min-h-11 items-center border-b px-4">
              <h2 id={attentionTitleId} className="text-sm font-medium">
        ...
        <section aria-labelledby={listTitleId} className="mt-8">
          <div className="flex min-h-10 items-center justify-between gap-3">
            <h2 id={listTitleId} className="text-sm font-medium">
          ...
          {loadState === "loading" || loadState === "idle" ? (
            ...
            <div className="flex min-h-72 flex-col items-center justify-center gap-3 p-6 text-center">
              ...
              <Button variant="outline" size="sm" onClick={() => void refresh(workflowClient)}>
        ...
        {workflows.length > 0 ? (
          ...
          >
            <div>
              <h2 id={templateTitleId} className="text-sm font-medium">
