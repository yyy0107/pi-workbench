...
export const WORKFLOW_MAIN_VIEW_TITLE = definePiMessage("extensions.workflows.title");
const WORKFLOW_HOME_TITLE = definePiMessage("extensions.workflows.workflowHome.title");
const AUTOMATION_MAIN_VIEW_TITLE = definePiMessage("extensions.workflows.automationHome.title");
const NEW_AUTOMATION_TASK_TITLE = definePiMessage("extensions.workflows.breadcrumb.newTask");
const CREATE_WORKFLOW_TITLE = definePiMessage("extensions.workflows.create.title");
const EDIT_WORKFLOW_TITLE = definePiMessage("extensions.workflows.breadcrumb.editor");
const WORKFLOW_RUNS_TITLE = definePiMessage("extensions.workflows.runs.title");
const WORKFLOW_TEMPLATES_TITLE = definePiMessage("extensions.workflows.templates.title");
