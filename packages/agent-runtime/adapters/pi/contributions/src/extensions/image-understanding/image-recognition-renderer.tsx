...
function methodLabel(method: ImageRecognitionMethod, t: ReturnType<typeof usePiI18n>["t"]): string {
  switch (method) {
    case "ocr":
...
function stageLabel(stage: ImageRecognitionStage, t: ReturnType<typeof usePiI18n>["t"]): string {
  switch (stage) {
    case "routing":
...
function errorLabel(kind: ImageRecognitionErrorKind, t: ReturnType<typeof usePiI18n>["t"]): string {
  switch (kind) {
    case "authentication":
...
function skipLabel(kind: ImageRecognitionSkipKind, t: ReturnType<typeof usePiI18n>["t"]): string {
  switch (kind) {
    case "native":
