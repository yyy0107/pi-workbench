...
import type { ComposerSubmission } from "@workbench/core-contracts/composer";
...
export class AgentExecutionError extends AgentServerError<AgentExecutionErrorCode> {
  constructor(code: AgentExecutionErrorCode, message: string, options?: ErrorOptions) {
    super("AgentExecutionError", code, message, options);
  }
}
