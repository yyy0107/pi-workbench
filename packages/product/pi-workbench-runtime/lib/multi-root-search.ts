import {
  truncateHead,
  type ToolDefinition,
  type createGrepToolDefinition,
  type createFindToolDefinition,
} from "@earendil-works/pi-coding-agent";
import { Type } from "typebox";

/** Shared bounded multi-root execution for the grep and find overrides. */
export function withMultiRootSearch(
  cwd: string,
  base: ReturnType<typeof createGrepToolDefinition> | ReturnType<typeof createFindToolDefinition>,
) {
        ...
        const result = await base.execute(
          id,
          {
            ...
            ...(base.name === "grep"
              ? {
                  context:
                    "context" in params && typeof params.context === "number" ? params.context : 2,
                }
              : {}),
          },
          signal,
