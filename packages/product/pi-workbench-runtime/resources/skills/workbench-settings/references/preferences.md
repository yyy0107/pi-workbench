...
| Ask User tool and timed continuation    | `askUserEnabled` (absent defaults to disabled), `askUserAutoContinue`: boolean                                                              |
| Workbench settings tool                 | `workbenchSettingsEnabled`: boolean; absent defaults to disabled                                                                            |
