# Extension dialogs, widgets, and autocomplete

> Pi 0.84.2 documentation snapshot. Source: `docs/extensions.md`, lines [2472–2700](https://github.com/earendil-works/pi/blob/v0.84.2/packages/coding-agent/docs/extensions.md#L2472-L2700).
...
**For custom components, see [tui.md](https://github.com/earendil-works/pi/blob/v0.84.2/packages/coding-agent/docs/tui.md)** which has copy-paste patterns for:
...
See [examples/extensions/timed-confirm.ts](https://github.com/earendil-works/pi/blob/v0.84.2/packages/coding-agent/examples/extensions/timed-confirm.ts) for complete examples.
