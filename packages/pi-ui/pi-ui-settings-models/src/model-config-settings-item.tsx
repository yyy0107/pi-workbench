...
import { usePiConfigurationClient } from "@workbench/pi-runtime-client/configuration";
import { PiApiError } from "@workbench/pi-runtime-client/errors";
import type {
...
import { modelProviderCredentialWebsite } from "../lib/model-provider-credential-links";
...
export function ModelConfigSettingsItem({ sectionId, itemId }: SettingsItemComponentProps) {
  const { number, t } = useI18n(piSettingsModelsTranslationBundle);
