"use client";
import { piSettingsModelsTranslationBundle } from "./i18n";
...
import { Button, StatusBadge } from "@workbench/ui";
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from "@workbench/ui";
import { DropdownMenu, DropdownMenuRadioGroup, DropdownMenuTrigger } from "@workbench/ui";
...
import type { PiSettingsModelsStaticMessageKey as PiStaticMessageKey } from "./i18n";
import {
  supportedModelThinkingLevels,
  verifiedImageInputCapability,
} from "@workbench/pi-runtime-adapters/models";
import type { ModelProviderModelConfiguration } from "@workbench/pi-rpc-contracts/rpc";
...
function ModelCatalogRowComponent({
  ...
  const { t } = useI18n(piSettingsModelsTranslationBundle);
