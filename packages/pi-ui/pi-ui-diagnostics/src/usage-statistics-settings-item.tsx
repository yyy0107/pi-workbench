...
import { usePiUsageStatisticsClient } from "@workbench/pi-runtime-client/usage-statistics";
import type { UsageStatisticsValue } from "@workbench/pi-rpc-contracts/rpc";
...
import {
  ...
  usageTrendSeries,
  type ActivityMode,
} from "../lib/usage-statistics-data";
