...
import { projectPiSessionSummary, translatePiThreadStoreError } from "./pi-agent-thread-store";
import type { PiSessionRegistry, ScratchSessionRecord } from "./session-registry";
import type { SessionRpcScratchRecord, SessionRpcScratchStore } from "./session-rpc-service";

function projectRecord(
  summary: AgentThreadSummary,
  record: ScratchSessionRecord,
