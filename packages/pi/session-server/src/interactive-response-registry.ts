import type { WorkbenchExtensionUIContext } from "@workbench/pi-server-ports/extension-ui";
export type { WorkbenchExtensionUIContext } from "@workbench/pi-server-ports/extension-ui";
...
export class InteractiveResponseRegistry {
  private readonly hub: PiStreamPublisher;
...
export function getInteractiveResponseRegistry(
  options: InteractiveResponseRegistryOptions,
  ...
  const registry = new InteractiveResponseRegistry(options);
...
export async function handleInteractiveResponsePost(
  request: Request,
  registry: InteractiveResponseRegistry,
): Promise<Response> {
