...
export class ExternalSessionImportService {
  ...
  private readonly dependencies: ExternalSessionImportDependencies;

  constructor(
    dependencies: ExternalSessionImportDependencies,
  ...
  private async importNow(
    ...
    for (const selection of selections) {
      ...
      try {
        ...
        this.dependencies.registerImportedSessionManager(manager);
        const workspaceStore = this.dependencies.getWorkspaceStore();
...
export function getExternalSessionImportService(
  ...
  service ??= new ExternalSessionImportService(dependencies);
  return service;
}
