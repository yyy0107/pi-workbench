...
import { pathWithin } from "../lib/resource-mutations";
import {
...
import { workbenchBuiltinResourceUrl } from "./builtin-resource-locations";
...
export async function ensureWorkbenchBuiltinResources(agentDir: string, extensionSource: URL) {
  const directories = {
