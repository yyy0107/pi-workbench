import type {
  ...
  ScopedResourceContextService,
} from "./scoped-resource-context";
...
import { readResourceTextFile } from "../lib/resource-text-file";
...
export class PromptService implements PromptCatalogProtocol {
  ...
  constructor(
    dependencies: Pick<PromptServiceDependencies, "scopedResources" | "mutationCoordinator"> &
      Partial<PromptServiceDependencies>,
  ) {
    this.dependencies = {
