import type {
  PiResourceMutationSessionHost,
  PiResourceMutationCoordinatorDependencies,
} from "@workbench/pi-server-ports/sessions";
export type {
  PiResourceMutationSessionHost,
  LoadedPiResourceMutationSessionHost,
  PiResourceMutationCoordinatorDependencies,
} from "@workbench/pi-server-ports/sessions";
import { workspaceFromCwd } from "../lib/workspace-paths";
...
export class PiResourceMutationCoordinator {
  ...
  constructor(
    dependencies: Pick<PiResourceMutationCoordinatorDependencies, "getLoadedSessions"> &
      Partial<PiResourceMutationCoordinatorDependencies>,
  ) {
    this.dependencies = {
      ...dependencies,
    };
