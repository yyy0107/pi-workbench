...
import { projectPiAgentCommands } from "@workbench/agent-runtime-pi-shared/commands";
import {
...
export class CommandService implements AgentCommandCatalogPort, CommandCatalogProtocol {
  ...
  constructor(
    dependencies: Pick<CommandServiceDependencies, "getSession" | "getScopedResourceHost"> &
      Partial<CommandServiceDependencies>,
  ) {
    this.dependencies = {
      ...dependencies,
    };
