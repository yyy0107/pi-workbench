...
import type { WorkspaceSessionSnapshot } from "@workbench/pi-server-ports/sessions";
export type { WorkspaceSessionSnapshot } from "@workbench/pi-server-ports/sessions";
...
export type { WorkspaceView } from "@workbench/agent-runtime-pi-protocol/rpc";
...
export class WorkspaceStore {
  ...
  private readonly publishHost?: PiStreamPublisher["publishHost"];
  ...
  constructor(options: WorkspaceStoreOptions | string) {
    ...
    this.publishHost = resolvedOptions.publishHost;
