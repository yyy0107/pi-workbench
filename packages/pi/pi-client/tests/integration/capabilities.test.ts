...
import type { ModelProvidersValue, ModelCatalogValue } from "@workbench/pi-protocol/rpc";
...
import { PiApiError, type PiHttpTransport } from "@workbench/pi-transport-client/api";
