...
import { validateWorkspace } from "@workbench/pi-resources-server/workspace-paths";
import { bindToolAvailability, type ToolCapabilitySettings } from "../lib/tool-availability";
