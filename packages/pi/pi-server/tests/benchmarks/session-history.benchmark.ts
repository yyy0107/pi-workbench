...
import type { SessionEvent } from "@workbench/pi-protocol/rpc";
import { fetchProgressiveSessionHistory } from "@workbench/pi-shared/sessions";

import { createPiAgentExecution } from "../../src/session-composition";

import { createPiAgentThreadStore } from "../../src/session-composition";

import { ColdSessionEventCache } from "@workbench/pi-session-server/cold-session-event-cache";
import { initializeSessionEventJournal } from "@workbench/pi-session-server/session-event-journal";
import { createPiSessionHistoryService } from "../../src/session-composition";

import { createPiSessionModelContextService } from "../../src/session-composition";

import {
  SessionRpcService,
  type SessionRpcWorkspaceStore,
} from "@workbench/pi-session-server/session-rpc-service";
...
async function runScenario(
  ...
  const service = new SessionRpcService({
    workspaceStore,
    execution: createPiAgentExecution(),
    threads: createPiAgentThreadStore(),
