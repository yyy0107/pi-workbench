...
import { WorkspaceStoreError } from "@workbench/pi-resources-server/workspace-store";
import { WorkspaceStore } from "../../src/resource-composition/workspace-store";

type WorkspaceStoreEvent =
  import("@workbench/pi-resources-server/workspace-store").WorkspaceStoreEvent;
...
async function expectStoreError(
  ...
  code: import("@workbench/pi-resources-server/workspace-store").WorkspaceStoreErrorCode,
  details: object,
): Promise<void> {
