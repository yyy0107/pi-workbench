...
import type { SessionContextTraceEvent } from "@workbench/pi-protocol/rpc";

const { SessionContextTraceJournal, SessionContextTraceJournalError } =
  (await import("@workbench/pi-session-server/session-context-trace-journal")) as typeof import("@workbench/pi-session-server/session-context-trace-journal");
const {
  ...
  (await import("@workbench/pi-session-server/session-context-trace")) as typeof import("@workbench/pi-session-server/session-context-trace");
