...
import { workspaceFromCwd } from "@workbench/pi-resources-server/workspace-paths";

const [sessionRpcModule, sessionHistoryModule, sessionModelContextModule] = await Promise.all([
  import("@workbench/pi-session-server/session-rpc-service") as Promise<
    typeof import("@workbench/pi-session-server/session-rpc-service")
  >,
...
type PiSessionHistory = import("@workbench/pi-protocol/messages").PiSessionHistory;
type ModelProviderGroup = import("@workbench/pi-protocol/rpc").ModelProviderGroup;
type SessionEvent = import("@workbench/pi-protocol/rpc").SessionEvent;
type WorkspaceView = import("@workbench/pi-protocol/rpc").WorkspaceView;
...
type PiSessionHistoryServiceDependencies =
  import("../../src/session-composition").PiSessionHistoryServiceDependencies;
type PiSessionModelContextServiceDependencies =
  import("../../src/session-composition").PiSessionModelContextServiceDependencies;
type SessionRpcWorkspaceStore =
  import("@workbench/pi-session-server/session-rpc-service").SessionRpcWorkspaceStore;
type SessionRpcScratchStore =
  import("@workbench/pi-session-server/session-rpc-service").SessionRpcScratchStore;
