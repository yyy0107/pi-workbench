...
const { configuredSessionCatalogIndexFile, readSessionCatalogIndex, writeSessionCatalogIndex } =
  (await import("@workbench/pi-session-server/session-catalog-index")) as typeof import("@workbench/pi-session-server/session-catalog-index");
const { listSessions, listSessionSearchText } =
