...
const SKILL_SERVICE = new URL("../../../pi-resources-server/src/skill-service.ts", import.meta.url);
const SKILL_RPC_ROUTES = new URL("../../src/routes/skill-rpc-routes.ts", import.meta.url);
