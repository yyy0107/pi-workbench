...
import * as Skills from "@workbench/pi-resources-server/skills";
import * as Extensions from "@workbench/pi-resources-server/extensions";
import * as Commands from "@workbench/pi-resources-server/commands";
import * as Prompts from "@workbench/pi-resources-server/prompts";
import * as Packages from "@workbench/pi-resources-server/packages";
import * as Contexts from "@workbench/pi-resources-server/contexts";
import * as Mutations from "@workbench/pi-resources-server/mutations";
import * as Workspaces from "@workbench/pi-resources-server/workspaces";
...
} from "@workbench/pi-tools/builtin-tools";
