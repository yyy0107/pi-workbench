...
const { handleSessionExportRequest } =
  (await import("../../src/session-composition")) as typeof import("../../src/session-composition");

type SessionExportDependencies = import("../../src/session-composition").SessionExportDependencies;
type SessionExportSessionInfo = import("../../src/session-composition").SessionExportSessionInfo;
