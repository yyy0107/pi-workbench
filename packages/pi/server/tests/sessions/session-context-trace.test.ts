...
const { sessionContextTracePromptPreview } =
  (await import("@workbench/pi-session-server/session-context-trace-summary")) as typeof import("@workbench/pi-session-server/session-context-trace-summary");
