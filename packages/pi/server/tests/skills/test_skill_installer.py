"""Offline check: python3 -B tests/skills/test_skill_installer.py (from the server package)."""
...
scripts = Path(__file__).resolve().parents[2] / "resources/skills/skill-installer/scripts"
