...
const RPC_DOMAIN_ERROR_PROJECTOR = new URL("../../../../host/server/src/rpc.ts", import.meta.url);
const REPOSITORY_ROOT = new URL("../../../../../", import.meta.url);

const EXPOSED_DOMAIN_ERRORS = [
  ["packages/pi/resources-server/src/command-service.ts", "CommandServiceError"],
  ["packages/pi/resources-server/src/extension-service.ts", "ExtensionServiceError"],
  ...
  ["packages/pi/model-server/src/model-service.ts", "ModelServiceError"],
  ["packages/pi/resources-server/src/installed-package-service.ts", "InstalledPackageServiceError"],
  ["packages/pi/resources-server/src/package-catalog-service.ts", "PiPackageCatalogServiceError"],
  ["packages/pi/resources-server/src/scoped-resource-context.ts", "ScopedResourceContextError"],
  [
    "packages/pi/session-server/src/pi-session-context-trace-service.ts",
    "PiSessionContextTraceServiceError",
  ],
  ["packages/pi/session-server/src/session-rpc-service.ts", "SessionRpcServiceError"],
  ["packages/pi/resources-server/src/agent-settings-service.ts", "AgentSettingsServiceError"],
  ["packages/server/settings/src/service.ts", "WorkbenchSettingsServiceError"],
  ["packages/pi/resources-server/src/skill-service.ts", "SkillServiceError"],
  ["packages/pi/resources-server/src/project-trust-service.ts", "ProjectTrustServiceError"],
  ...
  ["packages/pi/resources-server/src/workspace-store.ts", "WorkspaceStoreError"],
] as const;
