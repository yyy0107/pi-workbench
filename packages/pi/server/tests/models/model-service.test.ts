...
import { createWorkbenchAgentSessionServices } from "@workbench/pi-model-server/services";
import { createImageInputProbe } from "@workbench/pi-model-server/image-probe";

const { ModelService, ModelServiceError, toModelCatalogModel, createModelTestSession } =
  (await import("@workbench/pi-model-server")) as typeof import("@workbench/pi-model-server");
const { ModelConfigStore } =
  (await import("@workbench/pi-model-server/config")) as typeof import("@workbench/pi-model-server/config");

type ModelRuntimeLike = import("@workbench/pi-model-server").ModelRuntimeLike;
type ModelRuntimeModel = import("@workbench/pi-model-server").ModelRuntimeModel;
type ModelRuntimeProvider = import("@workbench/pi-model-server").ModelRuntimeProvider;
type ModelConfigStorage = import("@workbench/pi-model-server/config").ModelConfigStorage;
type StoredModelProviderConfiguration =
  import("@workbench/pi-model-server/config").StoredModelProviderConfiguration;
