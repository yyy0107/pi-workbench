import type { PiImageContent, PiQueuedPrompt, PiQueueMode } from "@workbench/pi-protocol/messages";
import {
  AgentExecutionError,
...
export function createPiAgentExecution(
  defaults: PiAgentExecutionDependencies,
  dependencies: Partial<PiAgentExecutionDependencies> = {},
): AgentExecutionPort {
  const implementation = { ...defaults, ...dependencies };
