import type { PiAssistantMessage, PiEvent, PiQueuedPrompt } from "@workbench/pi-protocol/messages";
...
import type { SessionMessageDelta, SessionMessageMetadata } from "@workbench/pi-protocol/stream";
import type { PlannedWorkbenchComposerCommand } from "@workbench/pi-resources-server/composer-command-planner";
