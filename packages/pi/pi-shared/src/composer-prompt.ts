import type { WorkbenchResolvedAgentRequest } from "@workbench/core-contracts/composer/request";
import type { PastedTextAttachment } from "@workbench/core-contracts/composer";
