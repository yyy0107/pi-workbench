...
import type { PiAssistantContent, PiAssistantMessage } from "@workbench/pi-protocol/messages";
import type { SessionMessageDelta } from "@workbench/pi-protocol/stream";
