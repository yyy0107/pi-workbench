...
浏览器和工作区文件端口使用 browser-contracts/host 与 agent-runtime-contracts/runtime-capabilities。目录会话快照属于 agent-runtime-contracts/workspace-catalog。本包不依赖浏览器适配器或 workspace-server 实现。
