import type { PiAgentMessage, PiSessionHistory } from "@workbench/pi-rpc-contracts/messages";
import type { SessionEvent, SessionHistoryValue } from "@workbench/pi-rpc-contracts/rpc";
...
export function createPiSessionHistoryService(
  defaults: PiSessionHistoryServiceDependencies,
