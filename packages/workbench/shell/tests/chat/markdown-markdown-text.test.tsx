...
import { WorkbenchCodeBlock } from "@workbench/code-highlighting";
...
import { I18nProvider, isLocalizableText } from "../../src/i18n";
import { WorkbenchSettingsProvider, type WorkbenchSettingsPort } from "@workbench/settings-runtime";
import { MarkdownTextContent, MarkdownTextContentWithCitations } from "@workbench/markdown/render";
      ...
      children: createElement(I18nProvider, {
        ...
        children: createElement(RightWorkspaceProvider, {
          ...
          children: createElement(ToastProvider, {
            children: createElement(MarkdownLinkAdapterProvider, {
              adapter: workspaceMarkdownLinkAdapter,
              children: node,
            }),
          }),
        }),
...
test("routes fenced code and code previews through the Workbench code block", () => {
  ...
  for (const node of [
    ...
    createElement(WorkbenchCodeBlock, { code, language: "typescript" }),
  ]) {
...
test("routes Mermaid fences to diagrams while keeping source previews literal", () => {
  ...
  const source = render(createElement(WorkbenchCodeBlock, { code, language: "mermaid" }));
