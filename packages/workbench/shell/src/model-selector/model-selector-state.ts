...
export function sessionSelectorModels(catalog: WorkbenchSessionModelCatalog): SelectorModel[] {
...
export function draftSelectorModels(catalog: WorkbenchModelCatalog): SelectorModel[] {
