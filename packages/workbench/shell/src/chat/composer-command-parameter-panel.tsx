      ...
      <div className="flex min-w-0 flex-col gap-1 sm:pt-1.5">
        <div className="flex min-w-0 items-center gap-2">
          ...
          <span
            className={
              field.required
                ? "inline-flex rounded-md bg-primary/10 px-1.5 py-0.5 text-[11px] leading-none font-medium text-primary"
    ...
    >
      <div className="flex min-w-0 flex-nowrap items-center justify-between gap-2 border-b px-3 py-2.5 sm:px-4">
        <div className="flex min-w-0 flex-1 items-center gap-2.5">
          <span className="bg-primary/10 text-primary flex size-[var(--icon-frame-size-default)] shrink-0 items-center justify-center rounded-lg">
