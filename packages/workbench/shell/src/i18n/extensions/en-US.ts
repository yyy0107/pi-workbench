...
export const extensionsEnUS = {
  ...
  workspaceBrowser: {
    ...
    fitToWidth: "Fit to workspace width",
    ...
    events: {
      ...
      navigate: "Allow the assistant to open this website?",
    ...
    settings: {
      ...
      fitToWidth: "Fit pages to workspace width",
      fitToWidthDescription:
        "Resize the browser viewport and fit wide pages to the available space.",
      ...
      navigate: "Approvals",
      navigateDescription: "Choose whether the assistant must ask before opening websites.",
