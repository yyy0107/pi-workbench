...
- Shell-owned built-in and installable component-extension copy belongs in
  `../i18n/extensions/<locale>.ts`, grouped by stable extension namespace. Do not create a private
  dictionary or translation hook for each small extension.
