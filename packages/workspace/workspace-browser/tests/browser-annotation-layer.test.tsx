...
import { Switch, Textarea } from "@workbench/ui";
import {
  BROWSER_SESSION_SERVICE_RESOURCE,
  MemoryBrowserSessionService,
} from "../src/browser-session-service";
import { BrowserAnnotationLayer } from "../src/browser-annotation-layer";
import type { BrowserSurfaceParams } from "../src/browser-surface";
