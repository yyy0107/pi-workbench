...
import { acquireFileViewerAssetBaseLease } from "../src/file-viewer-asset-base-lease";
  ...
  withBaseline("/existing-assets/", () => {
    ...
    try {
      assert.throws(
        ...
        /Cannot install File Viewer assets for \/second-assets\/: \/first-assets\/ is already active\./,
      );
