...
import { readFileBufferDraft, writeFileBufferDraft } from "../lib/file-buffer-draft";
...
import { isLargeTextFile } from "../lib/progressive-text-document";
  ...
  if (
    ...
    return (
      <UnavailableFile
        ...
        description={t("extensions.workspaceFile.capabilityUnavailable")}
      />
    );
  }
  return <AvailableFileSurface {...props} />;
}

function AvailableFileSurface({
  surface,
  isVisible,
  retryToken = 0,
