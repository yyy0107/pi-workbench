...
import { Button, Dialog } from "@workbench/ui";

import { installMinimalReactDomEnvironment } from "@workbench/ui-testkit";
import { RemoteDirectoryPickerDialog } from "../src/remote-directory-picker-dialog";
import { WorkspaceDirectoryPickerDialog } from "../src/workspace-directory-picker-dialog";
        ...
        root.render(
          <WorkbenchSettingsProvider service={{ load: async () => ({}), update: async () => {} }}>
            <I18nProvider
              locale="en-US"
              onLocaleChange={() => {}}
              bundles={[directoryPickerTranslationBundle, uiTranslationBundle]}
            >
              <RuntimeConnectionProvider
                key={scenario.origin}
