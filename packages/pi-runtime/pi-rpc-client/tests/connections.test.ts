...
import type { PiEvent } from "@workbench/pi-rpc-contracts/messages";
import type {
  HostStreamPayload,
  MuxStreamPayload,
  ServerRequest,
} from "@workbench/pi-rpc-contracts/stream";
import type { PiConnectionTimers, PiWebSocket, PiWebSocketMessageEvent } from "../src/connections";

const { PiConnectionController } = (await import(
  new URL("../src/connections.ts", import.meta.url).href
)) as typeof import("../src/connections");
