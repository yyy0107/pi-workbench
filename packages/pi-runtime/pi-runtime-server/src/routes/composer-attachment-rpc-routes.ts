...
import { INLINE_IMAGE_LIMITS } from "@workbench/pi-rpc-contracts/attachments";
...
import { ComposerAttachmentError } from "@workbench/pi-sdk-sessions/composer-text-attachments";
