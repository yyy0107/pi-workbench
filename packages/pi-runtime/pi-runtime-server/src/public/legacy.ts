...
} from "@workbench/pi-sdk-sessions/inline-image-admission";
...
type WorkspacePathsModule = typeof import("@workbench/pi-sdk-resources/workspace-paths");
...
export async function pickWorkspaceDirectory(
  ...
  const { pickWorkspaceDirectory: implementation } =
    await import("@workbench/pi-sdk-resources/workspace-paths");
  return implementation(...args);
}
