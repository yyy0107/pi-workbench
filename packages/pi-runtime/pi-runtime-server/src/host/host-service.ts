...
import type { HostDescription } from "@workbench/pi-rpc-contracts/rpc";
import { getAttachedSessionCount, listModels } from "../session-composition/registry";

import { canOpenHostPath } from "@workbench/local-host-server/directories";
import { ensureWorkbenchBuiltinResources } from "../resource-composition";
