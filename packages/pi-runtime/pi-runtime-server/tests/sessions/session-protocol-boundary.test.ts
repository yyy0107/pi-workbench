...
const SESSION_RPC_SERVICE = new URL(
  "../../../../pi-sdk/pi-sdk-sessions/src/session-rpc-service.ts",
  import.meta.url,
);
const SESSION_PROTOCOL_FACADE = new URL(
  "../../../../pi-sdk/pi-sdk-sessions/src/pi-session-protocol-facade.ts",
  import.meta.url,
);
const SESSION_CONTEXT_TRACE_SERVICE = new URL(
  "../../../../pi-sdk/pi-sdk-sessions/src/pi-session-context-trace-service.ts",
  import.meta.url,
);
const EXTERNAL_SESSION_IMPORT_SERVICE = new URL(
  "../../../../pi-sdk/pi-sdk-sessions/src/external-session-import-service.ts",
  import.meta.url,
);
const EXTERNAL_SESSION_TYPES = new URL(
  "../../../../pi-sdk/pi-sdk-sessions/src/external-session-types.ts",
  import.meta.url,
);
...
test("external import domain types reuse the stable browser-facing RPC contract", async () => {
  ...
  assert.match(source, /from\s+["']@workbench\/pi-rpc-contracts\/rpc["']/);
