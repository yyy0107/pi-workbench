...
import type { SessionContextTraceEvent } from "@workbench/pi-rpc-contracts/rpc";

const { SessionContextTraceJournal, SessionContextTraceJournalError } =
  (await import("@workbench/pi-sdk-sessions/session-context-trace-journal")) as typeof import("@workbench/pi-sdk-sessions/session-context-trace-journal");
const {
  ...
  (await import("@workbench/pi-sdk-sessions/session-context-trace")) as typeof import("@workbench/pi-sdk-sessions/session-context-trace");
