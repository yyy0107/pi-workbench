...
import { createImageInputProbe } from "@workbench/pi-sdk-models/image-probe";

const { ModelService, ModelServiceError, toModelCatalogModel, createModelTestSession } =
  (await import("@workbench/pi-sdk-models")) as typeof import("@workbench/pi-sdk-models");
const { ModelConfigStore } =
  (await import("@workbench/pi-sdk-models/config")) as typeof import("@workbench/pi-sdk-models/config");

type ModelRuntimeLike = import("@workbench/pi-sdk-models").ModelRuntimeLike;
type ModelRuntimeModel = import("@workbench/pi-sdk-models").ModelRuntimeModel;
type ModelRuntimeProvider = import("@workbench/pi-sdk-models").ModelRuntimeProvider;
type ModelConfigStorage = import("@workbench/pi-sdk-models/config").ModelConfigStorage;
type StoredModelProviderConfiguration =
  import("@workbench/pi-sdk-models/config").StoredModelProviderConfiguration;
