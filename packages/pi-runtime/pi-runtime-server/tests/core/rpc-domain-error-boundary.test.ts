...
const EXPOSED_DOMAIN_ERRORS = [
  ["packages/pi-sdk/pi-sdk-resources/src/command-service.ts", "CommandServiceError"],
  ["packages/pi-sdk/pi-sdk-resources/src/extension-service.ts", "ExtensionServiceError"],
  ...
  ["packages/pi-sdk/pi-sdk-models/src/model-service.ts", "ModelServiceError"],
  [
    "packages/pi-sdk/pi-sdk-resources/src/installed-package-service.ts",
    "InstalledPackageServiceError",
  ],
  [
    "packages/pi-sdk/pi-sdk-resources/src/package-catalog-service.ts",
    "PiPackageCatalogServiceError",
  ],
  ["packages/pi-sdk/pi-sdk-resources/src/scoped-resource-context.ts", "ScopedResourceContextError"],
  [
    "packages/pi-sdk/pi-sdk-sessions/src/pi-session-context-trace-service.ts",
    "PiSessionContextTraceServiceError",
  ],
  ["packages/pi-sdk/pi-sdk-sessions/src/session-rpc-service.ts", "SessionRpcServiceError"],
  ["packages/pi-sdk/pi-sdk-resources/src/agent-settings-service.ts", "AgentSettingsServiceError"],
  ["packages/server/settings-server/src/service.ts", "WorkbenchSettingsServiceError"],
  ["packages/pi-sdk/pi-sdk-resources/src/skill-service.ts", "SkillServiceError"],
  ["packages/pi-sdk/pi-sdk-resources/src/project-trust-service.ts", "ProjectTrustServiceError"],
