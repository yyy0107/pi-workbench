...
Default extension selection and order live in `@workbench/pi-workbench-runtime/extensions`. This package owns individual factories and execution adapters; its root exports result preparation and error reporting, not the product catalog.
