...
import { snapshotPiClientTransport, type PiClientTransport } from "@workbench/pi-rpc-client";
...
import { piSummaryFromSessionListItem } from "@workbench/pi-conversation-adapter/rpc";
import {
  PiClientSession,
  clientRunTiming,
