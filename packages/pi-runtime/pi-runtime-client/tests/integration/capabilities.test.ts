...
import type { ModelProvidersValue, ModelCatalogValue } from "@workbench/pi-rpc-contracts/rpc";
...
import { PiApiError, type PiHttpTransport } from "@workbench/pi-rpc-client/api";
