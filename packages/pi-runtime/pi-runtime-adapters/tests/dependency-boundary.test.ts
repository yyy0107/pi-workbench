...
const FORBIDDEN_IMPORT =
  /(?:from\s+|import\s*\()\s*["'](?:@\/|node:|react(?:\/|["'])|next(?:\/|["'])|@earendil-works\/pi-coding-agent|@workbench\/pi-(?:client|server)|\.\.\/\.\.\/\.\.\/\.\.\/\.\.\/runtime\/pi)/u;
...
test("the package exposes only the intentional shared protocol subpaths", async () => {
