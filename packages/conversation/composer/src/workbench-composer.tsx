...
import { ComposerCommandToken } from "./composer-controls";
...
import { composerCommandArgumentHint } from "../lib/composer-command-argument-hint";
import { sortComposerSuggestions } from "../lib/composer-command-group-order";
...
} from "../lib/composer-command-icon-color";
import {
...
import { addComposerFilesFromPaste } from "../lib/composer-image-paste";
import { canRestorePastedText } from "@workbench/agent-runtime-contracts/composer-attachments";
import { addComposerTextFromPaste } from "../lib/composer-text-paste";
...
import { formatAgentCommandLabel } from "../lib/agent-command";
import {
  ComposerAddMenuView,
