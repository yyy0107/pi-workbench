...
import { markScratchSessionPromoted } from "../../lib/side-chat/scratch-session-lease";
import { openPromotedSideChatConversation } from "../../lib/side-chat/side-chat-navigation";
