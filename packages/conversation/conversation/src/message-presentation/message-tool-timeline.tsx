...
import { toolDiffModel } from "../../lib/message-presentation/tool-diff-model";
import {
...
} from "../../lib/message-presentation/tool-timeline-model";
    ...
    void openers
      ...
      .catch(() => {
        addToast({
          ...
          type: "error",
          priority: "high",
          title: filesT("workspaceFiles.fileTree.openError", { name: fileDiff.filename }),
        });
      });
  }, [addToast, diffId, fileDiff, openers, filesT, workspaceContext]);
