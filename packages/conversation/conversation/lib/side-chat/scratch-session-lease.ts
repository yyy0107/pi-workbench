...
const leasesByManager = new WeakMap<WorkbenchScratchSessionCapability, Map<string, ScratchLease>>();

function leasesFor(manager: WorkbenchScratchSessionCapability): Map<string, ScratchLease> {
...
export function retainScratchSession(
  manager: WorkbenchScratchSessionCapability,
  sessionId: string,
): () => void {
...
export function markScratchSessionPromoted(
  manager: WorkbenchScratchSessionCapability,
  sessionId: string,
): void {
  const leases = leasesFor(manager);
