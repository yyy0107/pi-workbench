...
import type { SelectorModel } from "../lib/model-selector-state";
...
const {
  ...
  new URL("../lib/model-selector-state.ts", import.meta.url).href
)) as typeof import("../lib/model-selector-state");
const { createModelSelectorStore, parseRememberedModelSelection } = (await import(
  new URL("../src/model-selector-store.ts", import.meta.url).href
)) as typeof import("../src/model-selector-store");
