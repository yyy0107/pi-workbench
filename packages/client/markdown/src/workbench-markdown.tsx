...
import { useMarkdownLinkAdapter } from "./link-adapter";
...
const MarkdownBlock = memo(function MarkdownBlock({
  ...
  const linkAdapter = useMarkdownLinkAdapter();
  const content = useMemo(() => {
    ...
    const tree = markdownToHast(document, labels, idPrefix, linkAdapter.isLocalFileHref);
    if (decorateLinks) decorateMarkdownLinks(linkAdapter.isLocalFileHref)(tree);
    revealLeaves(tree);
  ...
  }, [node, source, streaming, components, labels, idPrefix, decorateLinks, linkAdapter]);
