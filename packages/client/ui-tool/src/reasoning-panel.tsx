      ...
      <CollapsibleTrigger className="group/trigger text-foreground/55 hover:text-foreground/90 flex w-full items-center gap-1.5 py-1 text-[13.5px] transition-colors outline-none">
        {streaming && activeIcon !== undefined ? (
          <span
            ...
            aria-hidden="true"
            className="flex size-(--icon-size-sm) shrink-0 [--button-icon-size:var(--icon-size-sm)] items-center justify-center"
          >
            {activeIcon}
          </span>
        ) : Icon ? (
          <Icon
            data-slot="reasoning-panel-icon"
            aria-hidden="true"
            className="text-foreground/45 size-(--icon-size-sm) shrink-0 [--button-icon-size:var(--icon-size-sm)]"
          />
        ) : null}
        <span
          className={cn(
