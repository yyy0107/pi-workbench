    ...
    <>
      {Icon && (
        <Icon
          ...
          aria-hidden="true"
          className={cn(
            "size-(--icon-size-sm) shrink-0 [--button-icon-size:var(--icon-size-sm)]",
      ...
      {!running && terminal ? (
        <CircleXIcon
          aria-hidden="true"
          className={cn(
            "fade-in zoom-in-90 animate-in size-(--icon-size-sm) shrink-0 [--button-icon-size:var(--icon-size-sm)] duration-200 motion-reduce:animate-none",
