    ...
    >
      {active ? (
        <LoaderIcon
          ...
          className="aui-tool-group-trigger-loader text-foreground/45 size-(--icon-size-sm) shrink-0 [--button-icon-size:var(--icon-size-sm)] animate-spin [animation-duration:0.6s] motion-reduce:animate-none"
        />
      ) : Icon ? (
        <Icon
          data-slot="tool-group-trigger-icon"
          aria-hidden
          className="aui-tool-group-trigger-icon text-foreground/45 size-(--icon-size-sm) shrink-0 [--button-icon-size:var(--icon-size-sm)]"
        />
      ) : null}
      <span
      ...
      <ChevronDownIcon
        ...
        className={cn(
          "aui-tool-group-trigger-chevron size-(--icon-size-sm) shrink-0 [--button-icon-size:var(--icon-size-sm)]",
