"use client";
import { uiMessageActionsTranslationBundle } from "./i18n";
...
import { isExpectedForkUnavailableError } from "../lib/fork-availability";
import { messageCacheHitRate, messageTokensPerSecond } from "../lib/message-performance-statistics";
import { shouldShowMessagePerformance } from "../lib/message-performance-visibility";
...
function MessagePerformance({ node }: Readonly<{ node: ConversationNode }>) {
  ...
  const { locale, number, t } = useI18n(uiMessageActionsTranslationBundle);
