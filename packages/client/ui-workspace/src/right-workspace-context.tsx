...
import {
  ...
  type RightWorkspaceController,
  type RightWorkspaceState,
  type RightWorkspaceStateStore,
  type WorkspaceDraftStore,
  type WorkspaceFeedbackSnapshot,
  type WorkspaceFeedbackStore,
...
export interface RightWorkspaceEnvironment {
  ...
  readonly draftStore: WorkspaceDraftStore;
}
...
/** Read/subscribe access for capability lifecycles; mutations go through the controller. */
export function useRightWorkspaceStateStore(): RightWorkspaceStateStore {
  return useRightWorkspaceEnvironment().store;
}
