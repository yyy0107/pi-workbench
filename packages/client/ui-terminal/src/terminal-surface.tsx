...
import {
  ...
  terminalResultLines,
} from "../lib/terminal-tool-transcript";
import styles from "./terminal-surface.module.css";
import { useTerminalToolCall } from "./use-terminal-tool-call";
import { terminalToolStatus, type ToolConnectionStatus } from "../lib/terminal-tool-status";
import { createTerminalResizeObserver } from "../lib/terminal-resize-observer";
...
function resolveTerminalTheme(container: HTMLElement): ITheme {
  ...
  return {
    ...
    // Shell prompts and directory listings commonly use normal or bright ANSI blue.
    // Resolve both from the owning Shell's accent on every appearance update.
    blue: accent,
    brightBlue: accent,
    background,
    foreground,
