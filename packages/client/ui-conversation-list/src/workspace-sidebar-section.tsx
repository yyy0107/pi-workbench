...
import { WorkspaceSidebarProvider, useWorkspaceSidebar } from "./sidebar-context";
...
function WorkspaceSidebarContent({
  ...
  return (
    <div
      ...
      className="min-h-0 flex-1 overflow-y-auto ps-3 pe-[2px] [overflow-anchor:none] [scrollbar-gutter:stable]"
    >
      <div
