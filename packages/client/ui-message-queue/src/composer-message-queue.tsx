"use client";
import { uiMessageQueueTranslationBundle } from "./i18n";
...
import { visibleComposerQueueItems } from "../lib/message-queue-preview";
...
function ComposerQueueItem({
  ...
  const { t } = useI18n(uiMessageQueueTranslationBundle);
