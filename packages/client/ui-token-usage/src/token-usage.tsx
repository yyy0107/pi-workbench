"use client";
import { tokenUsageTranslationBundle } from "./i18n";
...
import { sessionTokensPerSecond } from "../lib/token-throughput";
...
function ThreadTokenUsage() {
  const { locale, number, t } = useI18n(tokenUsageTranslationBundle);
