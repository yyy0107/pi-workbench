...
import { CODE_THEME_PAIRS, useAppearancePreferences, type CodeTheme } from "@workbench/appearance";
import { shouldHighlightWorkbenchCode } from "../lib/code-highlight-policy";
import { normalizeShikiLanguage } from "./shiki-catalog";
import { tokenStyle } from "../lib/shiki-token-style";
import type { createWorkbenchCodeStream, WorkbenchHighlightedTokens } from "./shiki-highlighter";
