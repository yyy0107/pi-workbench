...
import { languageForFilename, normalizeShikiLanguage } from "../src/shiki-catalog";
import { highlightWorkbenchCode, highlightWorkbenchCodeTokens } from "../src/shiki-highlighter";
