...
import { createI18n, SUPPORTED_LOCALES } from "@workbench/i18n/runtime";
import { uiTranslationBundle } from "../../src/i18n";
import { Toast, ToastProvider, useToastManager } from "../../src/components/toast";

test("event toasts use semantic tones and localized, accessible close controls", () => {
  for (const locale of SUPPORTED_LOCALES) {
    const { t } = createI18n(locale, [uiTranslationBundle]);
