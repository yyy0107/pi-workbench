...
import { shellOwnsKeyboardEvent } from "../../lib/keyboard-shortcut-owner";
...
function SidebarProvider({
  ...
  keyboardShortcutOwnerRef?: React.RefObject<HTMLElement | null>;
}) {
  ...
  React.useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      if (event.key === SIDEBAR_KEYBOARD_SHORTCUT && (event.metaKey || event.ctrlKey)) {
        if (
          keyboardShortcutOwnerRef &&
          !shellOwnsKeyboardEvent(keyboardShortcutOwnerRef.current, event, portalContainer?.current)
        ) {
          return;
        }
  ...
  }, [keyboardShortcutOwnerRef, portalContainer, toggleSidebar]);
        ...
        style={
          {
            ...
            "--sidebar-content-width": SIDEBAR_WIDTH,
