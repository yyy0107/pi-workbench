      ...
      >
        {done ? (
          <>
            <CheckIcon
              aria-hidden="true"
              className="size-(--icon-size-sm) shrink-0 [--button-icon-size:var(--icon-size-sm)]"
            />
          ...
          <>
            <Loader2Icon
              aria-hidden="true"
              className="size-(--icon-size-sm) shrink-0 [--button-icon-size:var(--icon-size-sm)] animate-spin motion-reduce:animate-none"
            />
