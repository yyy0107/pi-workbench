  ...
  return (
    ...
    >
      ...
      <span className="flex min-w-0 flex-wrap items-center justify-center gap-x-1.5 gap-y-0.5 text-center">
        {icon ? (
          <span className="size-(--icon-size-sm) shrink-0 [--button-icon-size:var(--icon-size-sm)] [&>svg]:size-full">
            {icon}
          </span>
        ) : null}
        ...
        <>
          {previousModel ? (
            <>
              ...
              <ArrowRightIcon
                aria-hidden="true"
                className="size-(--icon-size-sm) shrink-0 [--button-icon-size:var(--icon-size-sm)] rtl:rotate-180"
              />
            </>
          ) : null}
