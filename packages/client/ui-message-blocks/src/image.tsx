    ...
    >
      {!loaded &&
        ...
        (loadingPlaceholder ?? (
          ...
          >
            <ImageIcon className="text-muted-foreground size-(--icon-frame-size-default) shrink-0 [--button-icon-size:var(--icon-frame-size-default)] animate-pulse motion-reduce:animate-none" />
          </div>
        ))}
      {error ? (
        <div
        ...
        >
          <ImageOffIcon className="text-muted-foreground size-(--icon-frame-size-default) shrink-0 [--button-icon-size:var(--icon-frame-size-default)]" />
        </div>
      ) : (
        <img
          ref={imgRef}
  ...
  return (
    ...
    >
      {reason ? (
        <ShieldAlertIcon
          aria-hidden="true"
          className="text-muted-foreground size-(--icon-frame-size-default) shrink-0 [--button-icon-size:var(--icon-frame-size-default)]"
        />
      ) : (
        <ImageOffIcon
          aria-hidden="true"
