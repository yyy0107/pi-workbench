...
import { useAgentControlsI18n } from "@workbench/agent-controls/translations";
...
import { Button, StatusBadge, Tabs, TabsContent, TabsList, TabsTrigger } from "@workbench/ui";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
} from "@workbench/agent-controls/models";
import { reasoningEffortLabel } from "@workbench/agent-controls/reasoning";
...
import { automationProjectTrustDialogCopy } from "../lib/project-trust-dialog-copy";
import { focusFirstInvalidAutomationField } from "../lib/automation-invalid-focus";
import { automationSaveErrorMessage } from "../lib/automation-save-error";
                ...
                <InputGroup aria-invalid={promptInvalid}>
                  ...
                  >
                    <WorkspaceSelector
                      ...
                      variant="outline"
                      labels={{
                        select: directoryT("extensions.workspaceDirectory.selectTitle"),
                        clear: directoryT("extensions.workspaceDirectory.clearWorkspace"),
                        selecting: directoryT("extensions.workspaceDirectory.selecting"),
                        selectError: directoryT("extensions.workspaceDirectory.selectError"),
                        empty: t("extensions.automations.automationTask.noWorkspace"),
                        search: directoryT("extensions.workspaceDirectory.searchLabel"),
                        searchPlaceholder: directoryT(
                          "extensions.workspaceDirectory.searchPlaceholder",
                        ),
                        noSearchResults: directoryT(
                          "extensions.workspaceDirectory.noSearchResults",
                        ),
                      }}
                    ...
                    <ModelSelectorControl
                      labels={{
                        select: controlsT("assistant.model.select"),
                        provider: controlsT("extensions.modelSelector.provider"),
                        model: controlsT("assistant.model.model"),
                        reasoningEffort: controlsT("assistant.model.reasoningEffort"),
                        search: controlsT("extensions.modelSelector.searchLabel"),
                        searchPlaceholder: controlsT("extensions.modelSelector.searchPlaceholder"),
                        loadFailed: controlsT("extensions.modelSelector.loadFailed"),
                        noModels: controlsT("extensions.modelSelector.noModels"),
                        noSearchResults: controlsT("extensions.modelSelector.noSearchResults"),
                        selectFailed: controlsT("extensions.modelSelector.selectFailed"),
                        currentUnavailable: controlsT(
                          "extensions.modelSelector.currentUnavailable",
                        ),
                        saving: controlsT("extensions.modelSelector.saving"),
                      }}
                      ...
                      getEffortLabel={(effort) => reasoningEffortLabel(effort, controlsT)}
