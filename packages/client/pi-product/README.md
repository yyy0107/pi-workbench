...
Public imports: `@workbench/pi-product/application`, `@workbench/pi-product/installation`. Cross-package consumers use explicit exports and `workspace:*` dependencies.
