...
import type { RightWorkspaceController } from "@workbench/workspace-runtime";

import {
  createToggleTerminalCommand,
  getTerminalWorkspaceService,
} from "../src/open-terminal-command";
import {
  openTerminal,
  revealTerminalTranscript,
  type TerminalWorkspaceService,
} from "../src/terminal-workspace-service";
