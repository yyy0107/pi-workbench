"use client";
import { todoTranslationBundle } from "./i18n";
...
import { composerPanel, composerPanelIcon, composerPanelRow } from "@workbench/ui-composer/panels";
...
export function TodoPanelContent({ snapshots }: { snapshots: readonly TodoSnapshot[] }) {
  const { t } = useI18n(todoTranslationBundle);
