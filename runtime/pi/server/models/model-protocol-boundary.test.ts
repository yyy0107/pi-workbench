...
const MODEL_SERVICE = new URL("./model-service.ts", import.meta.url);
const MODEL_PROVIDER_ROUTES = new URL(
  "../transport/routes/model-provider-rpc-routes.ts",
  import.meta.url,
);
const MODEL_CONTEXT_WINDOW_ROUTES = new URL(
  "../transport/routes/model-context-window-rpc-routes.ts",
  import.meta.url,
);
