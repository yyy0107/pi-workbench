...
const INSTALLED_PACKAGE_SERVICE = new URL("./installed-package-service.ts", import.meta.url);
const PACKAGE_CATALOG_SERVICE = new URL("./package-catalog-service.ts", import.meta.url);
const INSTALLED_PACKAGE_ROUTES = new URL(
  "../transport/routes/installed-package-rpc-routes.ts",
  import.meta.url,
);
const PACKAGE_CATALOG_ROUTES = new URL(
  "../transport/routes/package-catalog-rpc-routes.ts",
  import.meta.url,
);
