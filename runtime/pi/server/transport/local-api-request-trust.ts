interface LocalApiTrustRequest {
  headers: Headers;
}
...
export function inspectConfiguredApiRequestTrust(
  request: LocalApiTrustRequest,
): ApiRequestTrustResult {
 ...
 */
export function isTrustedLocalApiRequest(request: LocalApiTrustRequest): boolean {
