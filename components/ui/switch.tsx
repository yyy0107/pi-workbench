  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "pointer-events-none block rounded-full [background:var(--switch-thumb-background)] shadow-xs transition-transform",
          compact
