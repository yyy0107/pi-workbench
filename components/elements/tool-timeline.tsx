  ...
  return (
    ...
    >
      ...
      <CollapsibleContent className={cn(collapsePanel, "outline-none")}>
          ...
          {take(steps, visibleSteps).map((step, index, shown) => {
            ...
            return (
              <div
                ...
                className="fade-in slide-in-from-bottom-1 animate-in fill-mode-both text-foreground/55 flex min-w-0 items-center gap-2 text-[13.5px] duration-300"
              >
        ...
        {children ? (
          <div data-slot="tool-timeline-details" className="pt-2.5">
            {children}
          </div>
        ) : null}
      </CollapsibleContent>
