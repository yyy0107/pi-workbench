import type {
  ...
  PanelLocation,
  PanelRegistry,
} from "@/platform/extensions/api/panel";
import { panelStore, type PanelStoreApi, type PanelStoreState } from "@/stores/panel-store";

export class PanelService {
  readonly #registry: PanelRegistry;
  readonly #store: PanelStoreApi;

  constructor(registry: PanelRegistry, store: PanelStoreApi = panelStore) {
